...
# menambahkan data baru didalam Dictionary dataKu
dataKu["Ket"] = "Lulus"
print(dataKu)
print("")

# memperbarui data baru didalam Dictionary dataKu
dataTambah = {"Hobi": "Olahraga", "alamat": "Pemalang"}
dataKu.update(dataTambah)
print(dataKu)
print("")


# menghapus salah satu data  didalam Dictionary dataKu
del dataKu['Hobi']
print(dataKu)
